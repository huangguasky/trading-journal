...
AGENT_PROFILES = {
    ...
    "standard": AgentProfile(
        key="standard",
        name="标准",
        description="兼顾技术、资讯和风险，适合日常问股。",
        agents=("行情", "技术", "资讯", "风险", "决策"),
        tools=("get_quote", "get_indicators", "search_news", "get_last_report", "get_market_context"),
        max_steps=5,
    ),
    "deep": AgentProfile(
        key="deep",
        name="深度",
        description="加入历史走势、策略和信号追踪，适合交易计划与复盘。",
        agents=("行情", "技术", "资讯", "策略", "风险", "追踪", "决策"),
        tools=(
            "get_quote",
            "get_history",
            "get_indicators",
